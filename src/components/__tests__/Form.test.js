...
describe('Form', () => {
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(<Form interviewers={interviewers} onSave={onSave} interviewer={null} name="rand" />)
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    const { getByText, queryByText } = render(<Form interviewers={interviewers} name={"Lydia Miller-Jones"} onSave={onSave} interviewer={interviewers[0].id} />)
