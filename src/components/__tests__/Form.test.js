...
describe('Form', () => {
  ...
  it("can successfully save after trying to submit an empty student name", () => {
    ...
    const { getByText, getByPlaceholderText, queryByText } = render(<Form interviewers={interviewers} onSave={onSave} interviewer={1} />)
  ...
  it("calls onCancel and resets the input field", () => {
    ...
    const { getByText, getByPlaceholderText, queryByText } = render(<Form interviewers={interviewers} name="Lydia Mill-Jones" onSave={jest.fn()} onCancel={onCancel} />)
